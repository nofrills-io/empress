...
import io.nofrills.empress.RequestHandler
...
internal class RequestHolder {
     ...
     * @return A [job][Job] for the request or null if the request was not found or has already completed.RulerBackend.kt
     */
